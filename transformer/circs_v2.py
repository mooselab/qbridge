...
class CircDataset:
    ...
    def load_training_data(self):
        ...
        """
        # RQ 2
        # file_path = f"../data/{self.mode}/full_model/G_list"
        file_path = f"../larger_circuits/data/{self.mode}/full_model/G_list"
        # RQ 3
        # file_path = f"../data/testing_data/full_model/G_list"
        if self.cut:
